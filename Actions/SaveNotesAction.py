...
class SaveNotesAction():  
    ...
    def Run(self,problemManager):
        problemManager.SaveNotes(self.filename)#,self.recordSha)
    ...
    class Factory:
      def CreateFromXML(self,xmlNode,problemManager): return SaveNotesAction.CreateFromXML(xmlNode,problemManager)
