...
# IO
from IO.XML import GetAttributeString,GetAttributeValueOrDefault,HasAttribute
...
class HydrogenSingleSiteEvaluationAction():  
    typeStr = "RunHydrogenSiteEvaluation"

    def __init__(self):   
       self.doPlots = False
       
    def Run(self,problemManager):
        problemManager.EvaluateHydrogenProject()
        if(self.doPlots):
          problemManager.theHydrogenDataManager.PlotResults()
    ...
    def ParseXMLNode(self,actionNode,problemManager):
       ...
       """
       self.doPlots = GetAttributeValueOrDefault(actionNode,"doPlots",self.doPlots) 
       return
    ...
    class Factory:
      def CreateFromXML(self,xmlNode,problemManager): return HydrogenSingleSiteEvaluationAction.CreateFromXML(xmlNode,problemManager)


# Factory Registrator
ActionFactory.AddFactory(HydrogenSingleSiteEvaluationAction.typeStr,HydrogenSingleSiteEvaluationAction.Factory())
