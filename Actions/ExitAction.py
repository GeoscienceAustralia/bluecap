...
# Action to exit the program (will do this by default when the program ends)
...
class ExitAction():  
    ...
    class Factory:
      def CreateFromXML(self,xmlNode,problemManager): return ExitAction.CreateFromXML(xmlNode,problemManager)
